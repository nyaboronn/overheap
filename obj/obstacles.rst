...
Hexadecimal [16-Bits]
                             ...
                             12 ;; Obstacle data
                             13 ;;
   4103 4F                   14 obstacle_x:     .db #80-1
   4104 52                   15 obstacle_y:     .db #82
   4105 01                   16 obstacle_w:     .db #1
   4106 04                   17 obstacle_h:     .db #4
                             18 
                             19 ;; CPCtelera Symbols
                             20 .globl cpct_getScreenPtr_asm
                             21 .globl cpct_drawSolidBox_asm
                             22 .globl cpct_scanKeyboard_asm
...
Hexadecimal [16-Bits]
                             ...
                             31 
                             32 ;;=========================================
                             33 ;; Update Obstacle Status
                             34 ;; DESTROYS: AF, BC, HL
                             35 ;;=========================================
   4107                      36 obstacle_update::
                             37 
                             38     ;; Move Obstacle to the left 
   4107 3A 03 41      [13]   39     ld a, (obstacle_x)                      ;; A = obstacleX value
                             40     
                             41     ; dec a. Activa los flags 
                             42     ; no es necesario hacer un cp
   410A 3D            [ 4]   43     dec a                                   ;; obstacle_x --
   410B 20 02         [12]   44     jr nz, not_restart_x                    ;; if obstacleX == 0 restart x
                             45     
                             46         ;; Restart obstacleX when it is 0
   410D 3E 4F         [ 7]   47         ld a, #80-1                         ;; A = start location
                             48 
   410F                      49     not_restart_x:
   410F 32 03 41      [13]   50     ld (obstacle_x), a                      ;; Update obstacleX value
                             51 
   4112 C9            [10]   52     ret
                             53 
                             54 ;;=========================================
                             55 ;; Checks Collision between obstacle and other obstacle
                             56 ;; Input:
                             57 ;;      => HL: Points to the other entity
                             58 ;; Return XXXXXXXXXXX
                             59 ;; DESTROYS: HL
                             60 ;;=========================================
   4113                      61 obstacle_checkCollision::
                             62     ;;
                             63     ;; If (obs_x + obs_w <= hero_x) => r_no_collision
                             64     ;; CENCIA
                             65     ;; obs_x + obs_w - hero_x <= 0
                             66     ;; Comprobar si está a la izquierda 
   4113 3A 03 41      [13]   67     ld a, (obstacle_x)              ;; A = obstacle_x
   4116 4F            [ 4]   68     ld c, a                         ;; C = obstacle_x
   4117 3A 05 41      [13]   69     ld a, (obstacle_w)              ;; A = obstacle_y
   411A 81            [ 4]   70     add c                           ;; A += C 
   411B 96            [ 7]   71     sub (hl)                        ;; A -= hero_x
   411C 28 16         [12]   72     jr z, no_collision              ;; if (<= 0)
   411E FA 34 41      [10]   73     jp m, no_collision              ;; then  no_colision
                             74 
                             75     ;;
                             76     ;; if (herox + herow <= obsx) => l_no_collision
                             77     ;; herox + herow - obsx
                             78     ;;
   4121 7E            [ 7]   79     ld a, (hl)                      ;; A = hero_x
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 51.
Hexadecimal [16-Bits]



   4122 23            [ 6]   80     inc hl                          ;; hl++ (heroy)
   4123 23            [ 6]   81     inc hl                          ;; hl++ (herow)
   4124 86            [ 7]   82     add (hl)                        ;; A +=  hero_w
   4125 4F            [ 4]   83     ld c, a                         ;; C = A
   4126 3A 03 41      [13]   84     ld a, (obstacle_x)              ;; A = obstacle_x
   4129 47            [ 4]   85     ld b, a                         ;; :O
   412A 79            [ 4]   86     ld a, c                         ;; :D
   412B 90            [ 4]   87     sub a, b                        ;; A = herox + herow - obsx
   412C 28 06         [12]   88     jr z, no_collision              ;; If (<=0) no collision
   412E FA 34 41      [10]   89     jp m, no_collision              ;;  theb no_collision    
                             90 
                             91     ;; Collision
   4131 3E FF         [ 7]   92     ld a, #0xFF
   4133 C9            [10]   93     ret
                             94 
   4134                      95     no_collision:
   4134 3E 00         [ 7]   96         ld a, #00
   4136 C9            [10]   97     ret
                             98 
                             99 ;;=========================================
                            100 ;; Draws the Obstacle
                            101 ;; DESTROYS:
                            102 ;;=========================================
   4137                     103 obstacle_draw::
                            104     
   4137 3E 0F         [ 7]  105     ld a, #0x0F                 ;; Patter color
   4139 CD 43 41      [17]  106     call drawObstacle           ;; Draw the obstacle
                            107 
   413C C9            [10]  108     ret
                            109     
                            110 ;;=========================================
                            111 ;; Erases the Obstacle
                            112 ;; DESTROYS:
                            113 ;;=========================================
   413D                     114 obstacle_erase::
                            115     
   413D 3E 00         [ 7]  116     ld a, #0x00                 ;; Pattern color
   413F CD 43 41      [17]  117     call drawObstacle           ;; Erase the obstacle
                            118 
   4142 C9            [10]  119     ret
                            120 
                            121 
                            ...
                            129 ;; Draw the Object
                            130 ;; INPUTS:
                            131 ;;      A => Colour Pattern
                            132 ;; DESTROYS: AF, BC, DE, HL
                            133 ;;===========================================================
   4143                     134 drawObstacle:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 52.
Hexadecimal [16-Bits]



   4143 F5            [11]  135     push af                             ;; Save A in the stack
                            136 
                            137     ;; Calculate Screen Position
   4144 11 00 C0      [10]  138     ld de, #0xC000                      ;; Video memory start position
   4147 3A 03 41      [13]  139     ld a, (obstacle_x)                  ;; |
   414A 4F            [ 4]  140     ld c, a                             ;; \X Coordinate
   414B 3A 04 41      [13]  141     ld a, (obstacle_y)                  ;; |
   414E 47            [ 4]  142     ld b, a                             ;; \Y Coordinate
   414F CD 9D 43      [17]  143     call  cpct_getScreenPtr_asm
                            144 
                            145     ;; Draw A Box
   ...
   4157 CD F0 42      [17]  149     call cpct_drawSolidBox_asm          ;; Draw a solid box
                            150 
   415A C9            [10]  151     ret
                            152 
                            153 ;;===========================================================
                            154 ;; Check User Input
                            155 ;; DESTROYS: AF, BC, DE, HL
                            156 ;;===========================================================
   415B                     157 checkUserInput:
                            158     ;; Scan the whole keyboard
   415B CD B9 43      [17]  159     call cpct_scanKeyboard_asm
                            160 
                            161     ;; Check fpr Key 'L' being pressed
   415E 21 04 10      [10]  162     ld hl, #Key_L                   ;; HL = Key_I keycode
   4161 CD B5 42      [17]  163     call cpct_isKeyPressed_asm      ;; Check if Key_I is pressed
   4164 FE 00         [ 7]  164     cp #0                           ;; Check A == 0
   4166 28 00         [12]  165     jr z, L_not_pressed             ;; Jump if A == 0
                            166 
                            167         ;; key_D is pressed
                            168         ;;call moveHeroRight          ;; move hero right 
                            169 
   4168                     170     L_not_pressed:
                            171 
   4168 C9            [10]  172     ret
