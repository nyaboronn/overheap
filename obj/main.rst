...
Hexadecimal [16-Bits]
                              ...
                              3 ;###########################################################################
                              4 ;;-----------------------------LICENSE NOTICE------------------------------------
                              5 ;;  This file is part of CPCtelera: An Amstrad CPC Game Engine
                              6 ;;  Copyright (C) 2018 ronaldo / Fremos / Cheesetea / ByteRealms (@FranGallegoBR)
                              7 ;;
                             ...
                             20 ;;-------------------------------------------------------------------------------
                             21  
                             22 ;; Include all CPCtelera constant definitions, macros and variables
...
Hexadecimal [16-Bits]
   ...
   4101 CD 77 41      [17]   45   call cpct_disableFirmware_asm
                             46  
   4104 0E 00         [ 7]   47   ld    c, #0
   4106 CD 6A 41      [17]   48   call cpct_setVideoMode_asm
                             49 
   4109 CD 66 40      [17]   50   call ent_new
   410C EB            [ 4]   51   ex	de, hl
   410D 21 5A 40      [10]   52   ld    hl,#enemy_data
   4110 CD 7C 40      [17]   53   call ent_copy
                             54  
   4113                      55 loop:
   4113 DD 21 51 40   [14]   56   ld    ix, #hero_data
   4117 CD B4 40      [17]   57   call ent_clear
   411A CD C4 40      [17]   58   call ent_update
   411D CD 9A 40      [17]   59   call ent_draw
                             60  
                             61  ;; ld    ix, #enemy_data
                             62  ;; call ent_clear
                             63  ;; call ent_update
                             64  ;; call ent_draw
                             65 
   4120 21 B4 40      [10]   66   ld  hl, #ent_clear
   4123 CD 82 40      [17]   67   call ent_doForAll
                             68 
   4126 21 C4 40      [10]   69   ld  hl, #ent_update
   4129 CD 82 40      [17]   70   call ent_doForAll
                             71 
   412C 21 9A 40      [10]   72   ld hl, #ent_draw
   412F CD 82 40      [17]   73   call ent_doForAll
                             74 
                             75 
   4132 CD 50 42      [17]   76   call  cpct_scanKeyboard_asm
                             77  
   4135 21 08 20      [10]   78   ld    hl, #Key_A
   4138 CD 4C 41      [17]   79  call  cpct_isKeyPressed_asm
   413B 28 0A         [12]   80   jr    z, a_no_pulsada
...
Hexadecimal [16-Bits]
                             ...
                             81 
   413D CD 66 40      [17]   82     call ent_new
   4140 EB            [ 4]   83     ex	de, hl
   4141 21 5A 40      [10]   84     ld    hl,#enemy_data
   4144 CD 7C 40      [17]   85     call ent_copy
                             86 
   4147                      87 a_no_pulsada:
                             88 
                             89 
   4147 CD 62 41      [17]   90   call cpct_waitVSYNC_asm
                             91  
                             92   ;; Loop forever
   414A 18 C7         [12]   93   jr    loop
